...
cmd/mockexec/mockexec test/testdata/testconfig.textproto -t 'SOME STRING' -o tmp/result tmp/test-input > /dev/null 2>&1
...
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
cmd/mockexec/mockexec test/testdata/testconfig.textproto -t 'SOME STRING' -o tmp/result tmp/test-input 'TEST' > /dev/null 2>&1
if [ $? -eq 0 ]
then
...
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
cmd/mockexec/mockexec test/testdata/testconfig.textproto -t 'SOME STRING' -o tmp/result > /dev/null 2>&1
if [ $? -eq 0 ]
then
...
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
cmd/mockexec/mockexec test/testdata/testconfig.textproto -t 'THIS IS NOT SOME STRING' -o tmp/result tmp/test-input > /dev/null 2>&1
if [ $? -eq 0 ]
then
...
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
cmd/mockexec/mockexec test/testdata/testconfig.textproto -d 'SOME STRING' -o tmp/result tmp/test-input > /dev/null 2>&1
if [ $? -eq 0 ]
then
...
# incorrect usage testcase 7 (missing configuration file)
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
...
# incorrect usage testcase 8 (nonexistent configuration file)
echo "INPUT" > tmp/test-input
echo "OUTPUT" > tmp/test-output
