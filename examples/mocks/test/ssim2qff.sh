...
examples/mocks/ssim2qff/ssim2qff -t '201809010005' -o tmp/output -d tmp/input
...
echo "I'm an input file." > tmp/input
examples/mocks/ssim2qff/ssim2qff -t '201809010005' -d tmp/input
if [ $? -eq 0 ]
then
...
echo "I'm an input file." > tmp/input
examples/mocks/ssim2qff/ssim2qff -t '0' -o tmp/output -d tmp/input
if [ $? -eq 0 ]
then
